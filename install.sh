...
sudo apt-get update
sudo apt-get install -y curl wget git ruby python3 python3-pip bc ack
...
echo "listen_addresses = '*'" | sudo -u postgres tee --append /etc/postgresql/*/main/postgresql.conf
