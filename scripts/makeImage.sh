...
if [ -d ${WORK_DIR}/file_ko ]; then
    ...
    mkdir -p ${IMAGE_DIR}/firmadyne/file_ko/
fi

if [ -d ${WORK_DIR}/md_ko ]; then
    cp -r ${WORK_DIR}/md_ko ${IMAGE_DIR}/firmadyne/md_ko/
else
    mkdir -p ${IMAGE_DIR}/firmadyne/md_ko/
fi

if [ -d ${WORK_DIR}/md_config ]; then
    cp -r ${WORK_DIR}/md_config ${IMAGE_DIR}/firmadyne/md_config/
else
    mkdir -p ${IMAGE_DIR}/firmadyne/md_config/
fi
